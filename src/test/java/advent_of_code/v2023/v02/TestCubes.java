...
public class TestCubes
{
    ...
    public void testExemple1()
    {
        Assert.assertEquals(8,
                            cubes.findGames1("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green\n"
    ...
    @Test
    public void testOfficiel1()
    {
        Assert.assertEquals(2720,
                            cubes.findGames1("Game 1: 1 red, 5 blue, 10 green; 5 green, 6 blue, 12 red; 4 red, 10 blue, 4 green\n"
    ...
    {
        Assert.assertEquals(2286,
                            cubes.findGames2("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green\n"
                                             + "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue\n"
                                             + "Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red\n"
                                             + "Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red\n"
                                             + "Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"));
    ...
    @Test
    public void testOfficiel2()
    {
        Assert.assertEquals(71535,
                            cubes.findGames2("Game 1: 1 red, 5 blue, 10 green; 5 green, 6 blue, 12 red; 4 red, 10 blue, 4 green\n"
                                             + "Game 2: 2 green, 1 blue; 1 red, 2 green; 3 red, 1 blue; 2 blue, 1 green, 8 red; 1 green, 10 red; 10 red\n"
                                             + "Game 3: 14 red, 9 green, 5 blue; 2 green, 5 red, 7 blue; 1 blue, 14 green; 6 green, 2 red\n"
                                             + "Game 4: 2 green, 3 blue, 9 red; 1 red, 1 green; 4 red, 4 blue; 1 blue, 19 red; 7 red\n"
                                             + "Game 5: 1 green, 10 blue, 4 red; 15 green, 4 red, 5 blue; 14 blue, 14 green, 2 red; 15 green, 7 blue, 1 red; 2 red, 9 green, 17 blue\n"
